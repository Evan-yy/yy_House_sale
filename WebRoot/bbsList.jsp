	...
	<body>
		<div id="container">
			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-4 bcid-cat">论坛</div>
						<div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='javascript:;'>主页</a> > <a href='javascript:;'>论坛</a> > </span></div>
					</div>
				</div>
			</div>
						...
						<!-- <aside class="sidebar col-md-3 inner-right" role="complementary">
							<section class="widget side-search">
								...
								<form class="searchform" id="searchform" name="formsearch" method="post" action="searchbbsList.do">
									...
									<div class="sform-div">
										<input type="text"  name="name" placeholder="输入论坛名称" id="s" />
