...
<div class="breadcrumb-wrapper">
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-4 bcid-cat">购买信息</div>
			<div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='javascript:;'>主页</a> > <a href='javascript:;'>购买信息</a> > </span></div>
		</div>
	</div>
</div>
			...
			<div class="main col-md-12 inner-left" role="main">
				<div class="prolist-wrap">
					<div id="portfolio-container">
						...
						<tr>
						<td>名称</td><td>购买时间</td><td>购买人</td><td>发布人电话(微信)</td><td>操作</td>
						</tr>
						...
						<td>
						<a href="deleteBuy.do?id=${yp.id }">删除</a></td>
						</tr>
						
						</c:forEach>
						 <tr>
								<td colspan="7"> <c:if test="${page.page>1}">
						              <a href="myBuyList.do?page=1" >首页</a>
						             <a href="myBuyList.do?page=${page.page-1 }"> 上一页</a> 
						             </c:if>
						    	     <c:if test="${page.page<page.totalPage}">
									<a href="myBuyList.do?page=${page.page+1 }">下一页</a>
									<a href="myBuyList.do?page=${page.totalPage }">末页</a>
								    </c:if> 
								</td>
						</tr>
						</table>
