...
<html>
	...
	<body>
		...
		<section id="home-section" class="slider1">
			...
			<section class="portfolio-section" id="index-portfolio">
				<div class="container">
					<h3 class="text-center section-title"><a href="javascript:;">出售房屋信息</a> </h3>
					<div class="portfolio-box owl-wrapper">
						<div class="owl-carousel" data-num="4">
            ...
            <section class="portfolio-section" id="index-portfolio">
                <div class="container">
                    <h3 class="text-center section-title"><a href="javascript:;">求购房屋信息</a> </h3>
                    <div class="portfolio-box owl-wrapper">
                        <div class="owl-carousel" data-num="4">
                            <c:forEach items="${glist4 }" var="sb">
                                <div class="item project-post">
                                    <div class="project-gallery"> <img src="./upload/${sb.img }" alt="${sb.name }" width="262px" height="262px"/>
                                        <div class="hover-box">
                                            <div class="inner-hover">
