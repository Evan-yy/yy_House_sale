						...
						<div class="main col-md-9 inner-left" role="main">
							<div class="about-page-wrap">
								...
								<div id="contact-wrap">
									...
									<c:if test="${goods.btype=='出售' }">
									<h3 class="msg-title"><a href="addBuy.do?fid=${goods.id }">购买</a></h3>
									</c:if>
                                        <c:if test="${goods.btype=='出租' }">
                                            <h3 class="msg-title"><a href="addBuy_zl.do?fid=${goods.id }">租赁</a></h3>
                                        </c:if>
									</c:if>
									</c:if>
									<c:if test="${sessionScope.user==null }">
