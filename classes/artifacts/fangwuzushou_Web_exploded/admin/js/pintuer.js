$(function(){
	...
	$('.banner').each(function(){
		...
		var fangwuzushous=e.attr("data-fangwuzushou");
		var fangwuzushous_s=e.attr("data-small");
		var fangwuzushous_m=e.attr("data-middle");
		var fangwuzushous_b=e.attr("data-big");
		var num=e.find(".carousel .fangwuzushou").length;
		var win=$(window).width();
		var i=1;

		if(interval==null){interval=5};
		if(fangwuzushous==null || fangwuzushous<1){fangwuzushous=1};
		if(fangwuzushous_s!=null && win>760){fangwuzushous=fangwuzushous_s};
		if(fangwuzushous_m!=null && win>1000){fangwuzushous=fangwuzushous_m};
		if(fangwuzushous_b!=null && win>1200){fangwuzushous=fangwuzushous_b};

		var fangwuzushouWidth=Math.ceil(e.outerWidth()/fangwuzushous);
		var page=Math.ceil(num/fangwuzushous);
		e.find(".carousel .fangwuzushou").css("width",fangwuzushouWidth+ "px");
		e.find(".carousel").css("width",fangwuzushouWidth*num + "px");
		
		var carousel=function(){
			i++;
			if(i>page){i=1;}
			$showbanner(e,i,fangwuzushous,num);
		};
		...
		if(pointer!=0 && page>1){
			...
			pager.find("li").click(function(){
				$showbanner(e,$(this).val(),fangwuzushous,num);
			});
	...
	$showbanner=function(e,i,fangwuzushous,num){
		var after=0,leftx=0;
		leftx = - Math.ceil(e.outerWidth()/fangwuzushous)*(fangwuzushous)*(i-1);
		if(i*fangwuzushous > num){after=i*fangwuzushous-num;leftx= - Math.ceil(e.outerWidth()/fangwuzushous)*(num-fangwuzushous);};
