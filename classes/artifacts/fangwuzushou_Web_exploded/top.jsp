	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav navbar-right" id="navigation">
				...
				<li class="Lev1">
					<a href="showGoodsList.do" class="menu1 ">出租房屋
						<i class="fa fa-caret-down"></i></a>
					<ul class="drop-down sub-menu2">
						<c:forEach items="${tlist }" var="t">
						<li class="Lev2">
							<a href="selectGoodsList.do?fid=${t.id }" class="menu2">${t.name }</a>
						</li>
						</c:forEach>
					</ul>
				</li>
				<li class="Lev1">
					<a href="showGoodsList_cs.do" class="menu1 ">出售房屋
						<i class="fa fa-caret-down"></i></a>
					<ul class="drop-down sub-menu2">
						<c:forEach items="${tlist }" var="t">
						<li class="Lev2">
							<a href="selectGoodsList_cs.do?fid=${t.id }" class="menu2">${t.name }</a>
						</li>
						</c:forEach>
					</ul>
				</li>
                <li class="Lev1">
                    <a href="showGoodsList_qz.do" class="menu1 ">求租房屋
                        <i class="fa fa-caret-down"></i></a>
                    <ul class="drop-down sub-menu2">
                        <c:forEach items="${tlist }" var="t">
                            <li class="Lev2">
                                <a href="selectGoodsList_qz.do?fid=${t.id }" class="menu2">${t.name }</a>
                            </li>
                        </c:forEach>
                    </ul>
                </li>
                <li class="Lev1">
                    <a href="showGoodsList_qg.do" class="menu1 ">求购房屋
                        <i class="fa fa-caret-down"></i></a>
                    <ul class="drop-down sub-menu2">
                        <c:forEach items="${tlist }" var="t">
                            <li class="Lev2">
                                <a href="selectGoodsList_qg.do?fid=${t.id }" class="menu2">${t.name }</a>
                            </li>
                        </c:forEach>
                    </ul>
                </li>
				<li class="Lev1">
					<a href="bbsList.do" class="menu1 ">论坛
					</a>
				</li>
				<li class="Lev1">
				...
				<li class="Lev1">
					...
					<ul class="drop-down sub-menu2">
                        ...
                        <li class="Lev2">
                            <a href="myGoodsList_qg.do" class="menu2">我的求购</a>
                        </li>
						<li class="Lev2">
							<a href="myBuyList.do" class="menu2">我的购买</a>
						</li>
                        <li class="Lev2">
                            <a href="myBuyList_zl.do" class="menu2">我的租赁</a>
                        </li>
						<li class="Lev2">
