	...
	<body>
		<div id="container">
			...
			<div class="breadcrumb-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-4 bcid-cat">求购房屋信息</div>
						<div class="col-md-9 col-sm-8 location"><i class="fa fa-map-marker"></i> &nbsp;<span>当前位置： <a href='javascript:;'>主页</a> > <a href='javascript:;'>求购房屋信息</a> > </span></div>
					</div>
				</div>
			</div>
			...
			<div class="page-container" id="innerpage-wrap">
				...
				<aside class="sidebar col-md-12 inner-right" role="complementary" style="    margin-bottom: 20px;">
							<section class="widget side-search">
								...
								<form class="searchform" id="searchform" name="formsearch" method="post" action="selectGoodsList_qg.do">
									<div class="sform-div">
										<input type="text"  name="name" placeholder="输入求购房屋名称" id="s" class="sidebar col-md-3 inner-right"   style="display: block; width: 15%;"/>
										<select name="price" class="sidebar col-md-3 inner-right"   style="display: block; width: 15%; height: 48px;">
										<option value="">请选择单价</option>
										<option value="1">8000元/m²以下</option>
										<option value="2">8000~10000元/m²</option>
										<option value="3">10000元/m²以上</option>
										</select>
								...
								<div id="portfolio-container">
									...
									<c:forEach items="${list }" var="u">
										<div class="portfolio-item isotope-item col-sm-4 col-xs-6">
											<article>
												...
												<h5 class="item-title"> <a href="showGoodsx.do?id=${u.id }" title="${u.name }">求购房屋名称：${u.name }</a> </h5>
									...
									<c:if test="${sessionScope.p==1 }">
										<c:if test="${page.page>1}">
							             <a href="showGoodsList_qg.do?page=1" >首页</a>
							             <a href="showGoodsList_qg.do?page=${page.page-1 }"> 上一页</a> 
							             </c:if>
							    	     <c:if test="${page.page<page.totalPage}">
									     <a href="showGoodsList_qg.do?page=${page.page+1 }">下一页</a>
										 <a href="showGoodsList_qg.do?page=${page.totalPage }">末页</a>
									    </c:if>
									    </c:if>
										...
										<c:if test="${page.page>1}">
							             <a href="showGoodsList_qg_commend.do?page=1" >首页</a>
							             <a href="showGoodsList_qg_commend.do?page=${page.page-1 }"> 上一页</a> 
							             </c:if>
							    	     <c:if test="${page.page<page.totalPage}">
									     <a href="showGoodsList_qg_commend.do?page=${page.page+1 }">下一页</a>
										 <a href="showGoodsList_qg_commend.do?page=${page.totalPage }">末页</a>
									    </c:if>
									    </c:if>
						...
						<!-- <aside class="sidebar col-md-3 inner-right" role="complementary">
							<section class="widget side-search">
								...
								<form class="searchform" id="searchform" name="formsearch" method="post" action="selectGoodsList_qg.do">
									...
									<div class="sform-div">
										<input type="text"  name="name" placeholder="输入求购房屋名称" id="s" />
										<input type="submit" id="searchsubmit" value="" />
									</div>
								</form>
							</section>
