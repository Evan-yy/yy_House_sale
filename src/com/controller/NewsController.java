...
//	首页显示内容
	...
	public String showIndex(ModelMap map){
		...
		Map<String, Object> jzmap2=new HashMap<>();
		Map<String, Object> jzmap3=new HashMap<>();
		Map<String, Object> jzmap4=new HashMap<>();
		...
		jzmap.put("btype", "出租");
		jzmap.put("status", "通过审核");
		
		jzmap2.put("pageno", 0);
		jzmap2.put("pageSize", 10);
		jzmap2.put("btype", "出售");
		jzmap2.put("status", "通过审核");

        jzmap3.put("pageno", 0);
        jzmap3.put("pageSize", 10);
        jzmap3.put("btype", "求租");
        jzmap3.put("status", "通过审核");

        jzmap4.put("pageno", 0);
        jzmap4.put("pageSize", 10);
        jzmap4.put("btype", "求购");
        jzmap4.put("status", "通过审核");
	...
	/*	List<Sysuser> ulist=userService.getByPage(jzmap);*/
		...
		List<Goods> clist3=goodsService.getAll(jzmap3);
		List<Goods> clist4=goodsService.getAll(jzmap4);
		...
		map.put("glist3", clist3);
		map.put("glist4", clist4);
