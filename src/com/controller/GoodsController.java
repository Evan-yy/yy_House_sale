...
public class GoodsController {
	...
	public String SelectGoods(@RequestParam(value = "page", required = false) String page, ModelMap map,
		...
		if (cd.getPrice1() != null && !cd.getPrice1().equals("")) {
			cmap.put("price1", cd.getPrice1());
			pmap.put("price1", cd.getPrice1());

		}
		if (cd.getZprice() != null && !cd.getZprice().equals("")) {
			cmap.put("zprice", cd.getZprice());
			pmap.put("zprice", cd.getZprice());

		}
		if (cd.getArea() != null && !cd.getArea().equals("")) {
			cmap.put("area", cd.getArea());
			pmap.put("area", cd.getArea());
    ...
    // 分页查询--显示个人的房屋信息
    @RequestMapping("myGoodsList_qg.do")
    public String myGoodsList_qg(@RequestParam(value = "page", required = false) String page, ModelMap map,
                                 HttpSession session) {
        Sysuser user = (Sysuser) session.getAttribute("user");
        if (user == null) {
            return "login";
            ...
            int num = goodsService.getCount(umap);
            if (num == 0) {
                return "redirect:doAddGoods_qg.do";
            } else {
                if (page == null || page.equals("")) {
                    page = "1";
                }
                ...
                List<Ftype> tlist = typeService.getAll(null);
                map.put("tlist", tlist);
                return "myGoodslist_qg";
            }
        }
    }

    @RequestMapping("selectGoodsList_qg.do")
    public String selectGoodsList_qg(@RequestParam(value = "page", required = false) String page, ModelMap map,
                                     HttpSession session, Goods cd) {
        if (page == null || page.equals("")) {
            page = "1";
        }
    ...
    // 处理添加房屋的信息
    @RequestMapping("doAddGoods_qg.do")
    public String doAddGoods_qg(ModelMap map, HttpSession session) {
        Sysuser user = (Sysuser) session.getAttribute("user");
        if (user == null) {
            return "login";
        } else {
    ...
    // 添加房屋信息
    @RequestMapping("addGoods_qg.do")
    public String addGoods_qg(@RequestParam(value = "file", required = false) MultipartFile file, String img,
                              HttpServletRequest request, Goods Goods, HttpSession session) {
        System.out.println("ddddd");
        Sysuser u = (Sysuser) session.getAttribute("user");
        System.out.println("u=-=" + u);
        if (u == null || u.equals("")) {
            ...
            Goods.setUid(u.getUid() + "");
            goodsService.add(Goods);
            return "redirect:myGoodsList_qg.do";
        }
    }

    // 处理更新房屋的信息
    @RequestMapping("doUpdateGoods_qg.do")
    public String doUpdateGoods_qg(ModelMap map, int id) {
        map.put("goods", goodsService.getById(id));
        List<Ftype> tlist = typeService.getAll(null);
        map.put("tlist", tlist);
        return "update_Goods_qg";
    }

    @RequestMapping("updateGoods_qg.do")
    public String updateGoods_qg(@RequestParam(value = "file", required = false) MultipartFile file, String img,
                                 HttpServletRequest request, Goods Goods) {
        img = fileUpload(file, request, img);
        if (img != null && !img.equals("zanwu.jpg")) {
            Goods.setImg(img);
    ...
    @RequestMapping("deleteGoods_qg.do")
    public String deleteGoods_qg(int id) {
        Map<String, Object> map = new HashMap<>();
        map.put("fid", id);
        List<Keep> klist = keepService.getAll(map);
        Keep keep = new Keep();
    ...
    @RequestMapping("showGoodsList_qg.do")
    public String showGoodsList_qg(@RequestParam(value = "page", required = false) String page, ModelMap map,
                                   HttpSession session, Goods cd) {
        if (page == null || page.equals("")) {
            page = "1";
        }
    ...
    @RequestMapping("selectGoodsList_qz.do")
    public String selectGoodsList_qz(@RequestParam(value = "page", required = false) String page, ModelMap map,
                              HttpSession session, Goods cd) {
        if (page == null || page.equals("")) {
            page = "1";
        }
    ...
    // 分页查询--显示所有的房屋信息
    @RequestMapping("admin/goodsList_qg.do")
    public String goodsList_qg(@RequestParam(value = "page", required = false) String page, ModelMap map,
                               HttpSession session) {
        Sysuser u = (Sysuser) session.getAttribute("auser");
        System.out.println("u=-=" + u);
        if (u == null || u.equals("")) {
            ...
            map.put("ulist", userService.getAll(null));
            session.setAttribute("p", 1);
            return "admin/goods_list_qg";
        }
    }

    // 分页查询--查询所有的房屋信息
    @RequestMapping("admin/goodsList_qg_search.do")
    public String goodsList_qg_search(@RequestParam(value = "page", required = false) String page, ModelMap map,
                                      HttpSession session, Goods goods) {
        Sysuser u = (Sysuser) session.getAttribute("auser");
        System.out.println("u=-=" + u);
        if (u == null || u.equals("")) {
